    ...
    const loadLibraries = async () => {
      ...
      const sketch = (p: any) => {
        ...
        function makeUnderwaterSound(intensity = 0.5) {
          ...
          let duration = p.map(bendAmount, 0, 1, 0.4, 1.2);
          let maxAmp = p.map(speed, 0, 20, 0.3, 0.8) * p.map(stretchAmount, 0, 10, 1, 1.5);
        ...
        function makeClickSound() {
          ...
          if (clickOsc && clickOsc.frequency) {
            ...
            clickOsc.volume.setValueAtTime(-18, Tone.now());
          }
        ...
        function makeSqueakSound(intensity: number) {
          ...
          if (squeakOsc && squeakOsc.frequency) {
            ...
            squeakOsc.volume.setValueAtTime(-18, Tone.now());
          }
